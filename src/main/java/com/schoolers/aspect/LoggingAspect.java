package com.schoolers.aspect;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.schoolers.config.LoggingContext;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(@com.schoolers.annotations.LogRequestResponse * *(..))")
    public void methodWithLoggedRequestResponse() {
    }


    @Pointcut("within(@com.schoolers.annotations.LogRequestResponse *)")
    public void classWithLogRequestResponse() {
    }

    @Pointcut("within(@com.schoolers.annotations.LogResponse *)")
